...
export function App() {
  ...
  useEffect(() => {
    const handleHash = () => {
      ...
      } else if (window.location.hash === '' || window.location.hash === '#universe' || window.location.hash === '#home') {
        setCurrentView('home');
      }
    };
    handleHash();
    ...
    >
      {currentView === 'marketplace' ? (
        ...
        <>
          ...
          <section className="py-12 bg-gradient-to-r from-[#016ba5]/10 via-[#fa8221]/10 to-[#7C3AED]/10 border-b border-slate-200">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="font-body text-xs text-slate-500">Screen-Free Kits & Gear</span>
                  </div>
      ...
      <section className="py-16 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-12">
            ...
            <h2 className="font-headline text-3xl sm:text-4xl font-extrabold text-[#1E293B] tracking-tight mb-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 mb-14">
            ...
            {/* Primary Brand (40%) */}
            <div className="p-4 rounded-2xl border-2 border-[#016ba5]/30 bg-[#016ba5]/5 hover:shadow-lg transition-all flex flex-col justify-between">
              <div>
                ...
                <div className="flex items-center justify-between mb-1">
                  <span className="font-headline font-bold text-sm text-[#016ba5]">Primary Brand</span>
                  <span className="font-gamification text-xs bg-[#016ba5] text-white px-2 py-0.5 rounded-full font-bold">
                    40%
                  </span>
                </div>
                <div className="font-body text-xs text-slate-500 mb-2">Role: Brand / Structure</div>
                <p className="font-body text-[11px] text-slate-600 leading-snug">
            ...
            {/* Secondary CTA (35%) */}
            <div className="p-4 rounded-2xl border-2 border-[#fa8221]/30 bg-[#fa8221]/5 hover:shadow-lg transition-all flex flex-col justify-between">
              <div>
                ...
                <div className="font-body text-xs text-slate-500 mb-2">Role: Action / CTA</div>
                <p className="font-body text-[11px] text-slate-600 leading-snug">
            ...
            {/* Success Color (4%) */}
            <div className="p-4 rounded-2xl border border-[#22C55E]/30 bg-[#22C55E]/5 hover:shadow-md transition-all flex flex-col justify-between">
              <div>
                ...
                <div className="flex items-center justify-between mb-1">
                  <span className="font-headline font-bold text-sm text-[#16a34a]">Success</span>
                  <span className="font-gamification text-xs bg-[#22C55E] text-white px-2 py-0.5 rounded-full font-bold">
                    4%
                  </span>
                </div>
                <div className="font-body text-xs text-slate-500 mb-2">Role: Achievement</div>
                <p className="font-body text-[11px] text-slate-600 leading-snug">
            ...
            {/* Warning Color (3%) */}
            <div className="p-4 rounded-2xl border border-[#FACC15]/40 bg-[#FACC15]/10 hover:shadow-md transition-all flex flex-col justify-between">
              <div>
                ...
                <div className="flex items-center justify-between mb-1">
                  <span className="font-headline font-bold text-sm text-[#ca8a04]">Attention</span>
                  <span className="font-gamification text-xs bg-[#ca8a04] text-white px-2 py-0.5 rounded-full font-bold">
                    3%
                  </span>
                </div>
                <div className="font-body text-xs text-slate-500 mb-2">Role: Warning / Notice</div>
                <p className="font-body text-[11px] text-slate-600 leading-snug">
            ...
            {/* Deep Contrast (4%) */}
            <div className="p-4 rounded-2xl border border-[#1C1C1C]/30 bg-[#1C1C1C]/5 hover:shadow-md transition-all flex flex-col justify-between">
              <div>
                ...
                <div className="flex items-center justify-between mb-1">
                  <span className="font-headline font-bold text-sm text-[#1C1C1C]">Deep Contrast</span>
                  <span className="font-gamification text-xs bg-[#1C1C1C] text-white px-2 py-0.5 rounded-full font-bold">
                    4%
                  </span>
                </div>
                <div className="font-body text-xs text-slate-500 mb-2">Role: Depth</div>
                <p className="font-body text-[11px] text-slate-600 leading-snug">
            ...
            <div className="p-4 rounded-2xl border border-[#7C3AED]/30 bg-[#7C3AED]/5 hover:shadow-md transition-all flex flex-col justify-between">
              <div>
                ...
                <div className="flex items-center justify-between mb-1">
                  <span className="font-headline font-bold text-sm text-[#7C3AED]">Gamification</span>
                  <span className="font-gamification text-xs bg-[#7C3AED] text-white px-2 py-0.5 rounded-full font-bold">
                    4%
                  </span>
                </div>
                <div className="font-body text-xs text-slate-500 mb-2">Role: Adventure</div>
                <p className="font-body text-[11px] text-slate-600 leading-snug">
            ...
            {/* Info / Clarity (4%) */}
            <div className="p-4 rounded-2xl border border-[#38BDF8]/30 bg-[#38BDF8]/5 hover:shadow-md transition-all flex flex-col justify-between">
              <div>
                ...
                <div className="flex items-center justify-between mb-1">
                  <span className="font-headline font-bold text-sm text-[#0284c7]">Info / Clarity</span>
                  <span className="font-gamification text-xs bg-[#0284c7] text-white px-2 py-0.5 rounded-full font-bold">
                    4%
                  </span>
                </div>
                <div className="font-body text-xs text-slate-500 mb-2">Role: Accent / Info</div>
                <p className="font-body text-[11px] text-slate-600 leading-snug">
            ...
            {/* Foundation Base (2%) */}
            <div className="p-4 rounded-2xl border border-[#0A2540]/30 bg-[#0A2540]/5 hover:shadow-md transition-all flex flex-col justify-between">
              <div>
                ...
                <div className="flex items-center justify-between mb-1">
                  <span className="font-headline font-bold text-sm text-[#0A2540]">Foundation</span>
                  <span className="font-gamification text-xs bg-[#0A2540] text-white px-2 py-0.5 rounded-full font-bold">
                    2%
                  </span>
                </div>
                <div className="font-body text-xs text-slate-500 mb-2">Role: Base Surface</div>
                <p className="font-body text-[11px] text-slate-600 leading-snug">
            ...
            {/* Primary Text (2%) */}
            <div className="p-4 rounded-2xl border border-slate-200 bg-slate-50 hover:shadow-md transition-all flex flex-col justify-between">
              <div>
                ...
                <div className="flex items-center justify-between mb-1">
                  <span className="font-headline font-bold text-sm text-[#1E293B]">Primary Text</span>
                  <span className="font-gamification text-xs bg-[#1E293B] text-white px-2 py-0.5 rounded-full font-bold">
                    2%
                  </span>
                </div>
                <div className="font-body text-xs text-slate-500 mb-2">Role: Readability</div>
                <p className="font-body text-[11px] text-slate-600 leading-snug">
            ...
            <div className="p-4 rounded-2xl border border-slate-200 bg-slate-50 hover:shadow-md transition-all flex flex-col justify-between">
              <div>
                ...
                <div className="flex items-center justify-between mb-1">
                  <span className="font-headline font-bold text-sm text-[#64748B]">Secondary Text</span>
                  <span className="font-gamification text-xs bg-[#64748B] text-white px-2 py-0.5 rounded-full font-bold">
                    2%
                  </span>
                </div>
                <div className="font-body text-xs text-slate-500 mb-2">Role: Support</div>
                <p className="font-body text-[11px] text-slate-600 leading-snug">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-3xl p-6 sm:p-8">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="font-body text-xs text-slate-500">Strictly Enforced (Brand Page 4-7)</span>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
                <div className="flex items-center justify-between mb-2">
                  <span className="font-headline font-black text-xl text-[#016ba5]">Aa Montserrat</span>
                  <span className="text-[11px] font-body bg-[#016ba5]/10 text-[#016ba5] px-2 py-0.5 rounded-md font-bold">
                    Primary Font
                  </span>
                </div>
                <div className="font-headline font-bold text-base text-slate-800 mb-1">
              ...
              <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
                <div className="flex items-center justify-between mb-2">
                  <span className="font-body font-bold text-xl text-[#1E293B]">Aa Roboto Mono</span>
                  <span className="text-[11px] font-body bg-slate-100 text-slate-700 px-2 py-0.5 rounded-md font-bold">
                    Secondary Font
                  </span>
                </div>
                <div className="font-headline font-bold text-base text-slate-800 mb-1">
                ...
                <div className="pt-2 border-t border-slate-100 font-body text-xs text-slate-600 bg-slate-50 p-2 rounded-lg">
              ...
              <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm">
                <div className="flex items-center justify-between mb-2">
                  <span className="font-gamification font-bold text-2xl text-[#7C3AED]">Aa Baloo 2</span>
                  <span className="text-[11px] font-body bg-[#7C3AED]/10 text-[#7C3AED] px-2 py-0.5 rounded-md font-bold">
                    Gamification Only
                  </span>
                </div>
                <div className="font-headline font-bold text-base text-slate-800 mb-1">
      ...
      <section className="py-16 bg-slate-50 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-2xl mx-auto mb-10">
            <h2 className="font-headline text-3xl font-extrabold text-[#1E293B] tracking-tight mb-2">
              Official Logo Specifications
            </h2>
            <p className="font-body text-xs sm:text-sm text-[#64748B]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white border border-slate-200 rounded-2xl p-8 flex flex-col items-center justify-center text-center shadow-sm">
              ...
              <span className="font-headline font-bold text-sm text-[#016ba5] mb-1">White / Light Surface</span>
      ...
      <section id="safety-pledge" className="py-20 bg-white border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <h2 className="font-headline text-3xl sm:text-4xl font-extrabold text-[#1E293B] tracking-tight mt-4 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card variant="interactive" borderHighlight="primary" className="p-6">
              <div className="w-12 h-12 rounded-2xl bg-[#016ba5]/10 text-[#016ba5] flex items-center justify-center mb-5">
                <EyeOff className="w-6 h-6" />
              </div>
              <h3 className="font-headline text-lg font-bold text-slate-800 mb-2">
                100% Ad-Free
              </h3>
            ...
            <Card variant="interactive" borderHighlight="success" className="p-6">
              <div className="w-12 h-12 rounded-2xl bg-[#22C55E]/10 text-[#16a34a] flex items-center justify-center mb-5">
      ...
      <section id="quests-section" className="py-20 bg-slate-50/70 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div>
              ...
              <h2 className="font-headline text-3xl sm:text-4xl font-extrabold text-[#1E293B] tracking-tight">
                Embark on Moral Quests
              </h2>
              <p className="font-body text-xs sm:text-sm text-[#64748B] mt-1">
                Explore how the design system balances Montserrat headlines, Roboto Mono body, and Baloo rewards.
              </p>
            </div>

            {/* Category Filter Tabs */}
            <div className="flex items-center gap-2 bg-white p-1.5 rounded-xl border border-slate-200 shadow-sm font-headline text-xs font-semibold">
              <button
              ...
              return (
                ...
                >
                  <div>
                    ...
                    <h3 className="font-headline text-xl font-bold text-slate-900 mb-2 leading-snug">
                      {quest.title}
                    </h3>

                    {/* Quest Body using Roboto Mono font */}
                    <p className="font-body text-xs text-[#64748B] leading-relaxed mb-6">
                      {quest.description}
                    </p>
                  </div>
                  ...
                  <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
                    <span className="font-body text-[11px] text-slate-500 font-medium">
                      Value: <strong className="text-slate-700">{quest.value}</strong>
                    </span>
