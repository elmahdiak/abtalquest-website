...
export const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({
  ...
  return (
    <div
      className={cn(
        "fixed bottom-4 right-4 sm:bottom-6 sm:right-6 md:bottom-7 md:right-7 z-40 flex items-center group",
    ...
    >
      ...
      >
        ...
        <span className="absolute top-0 right-0 w-3 h-3 sm:w-3.5 sm:h-3.5 md:w-4 md:h-4 rounded-full bg-emerald-400 border-2 border-white dark:border-slate-900 shadow-sm flex items-center justify-center">
