...
export const MarketplaceHeader: React.FC<MarketplaceHeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-30 w-full bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 transition-colors shadow-sm">
      <div className="max-w-7xl 2xl:max-w-[1600px] mx-auto px-3 sm:px-6 lg:px-8 py-2.5 sm:py-3">
        <div className="flex flex-col md:flex-row items-center justify-between gap-2.5 sm:gap-3">
          ...
          <div className="w-full md:w-auto flex items-center justify-between md:justify-start gap-2 sm:gap-3">
            <button
              ...
              type="button"
              className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-3.5 py-2 sm:py-2.5 rounded-xl bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-800 dark:text-slate-200 text-xs sm:text-sm font-semibold transition-all duration-150 border border-slate-200 dark:border-slate-700 active:scale-95 cursor-pointer"
            ...
            <div className="flex md:hidden items-center gap-1.5 sm:gap-2">
              ...
              >
                <Heart className={cn('w-4 h-4 sm:w-5 sm:h-5', wishlistCount > 0 && 'fill-rose-500 text-rose-500')} />
                {wishlistCount > 0 && (
                  <span className="absolute -top-1 -right-1 min-w-[16px] h-[16px] sm:min-w-[18px] sm:h-[18px] flex items-center justify-center text-[9px] sm:text-[10px] font-bold text-white bg-rose-500 rounded-full px-1">
                    {wishlistCount}
                  </span>
                )}
              </button>
              ...
              <button
                type="button"
                onClick={onOpenCart}
                className="relative flex items-center gap-1 px-2.5 sm:px-3 py-1.5 sm:py-2 rounded-xl bg-[#fa8221] text-white font-bold text-xs sm:text-sm shadow-sm active:scale-95 transition-all"
